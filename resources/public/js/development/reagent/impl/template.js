...
var G__2000 = o;
(G__2000[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__2002__i < G__2002__a.length) {G__2002__a[G__2002__i] = arguments[G__2002__i + 0]; ++G__2002__i;}
  args = new cljs.core.IndexedSeq(G__2002__a,0,null);
} 
...
var G__2004 = o;
(G__2004[reagent.impl.template.cached_custom_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__2009 = props;
var G__2009__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__2009,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__2009);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__2009__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__2010){
var map__2011 = p__2010;
var map__2011__$1 = (((((!((map__2011 == null))))?(((((map__2011.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__2011.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__2011):map__2011);
var props = map__2011__$1;
var class$ = cljs.core.get.call(null,map__2011__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_.call(null,class$)){
return cljs.core.assoc.call(null,props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",cljs.core.keep.call(null,((function (map__2011,map__2011__$1,props,class$){
return (function (c){
...
});})(map__2011,map__2011__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__2013){
var map__2014 = p__2013;
var map__2014__$1 = (((((!((map__2014 == null))))?(((((map__2014.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__2014.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__2014):map__2014);
var on_write = cljs.core.get.call(null,map__2014__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__2014,map__2014__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__2014,map__2014__$1,on_write))
);
} else {
...
var G__2017 = jsprops;
(G__2017["defaultValue"] = value);

(G__2017["onChange"] = ((function (G__2017,v,value,on_change){
return (function (p1__2016_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__2016_SHARP_);
});})(G__2017,v,value,on_change))
);
...
var vec__2020 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__2020,(0),null);
var id = cljs.core.nth.call(null,vec__2020,(1),null);
var class$ = cljs.core.nth.call(null,vec__2020,(2),null);
...
var jsprops = ({"argv": v});
var temp__5724__auto___2024 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5724__auto___2024 == null)){
} else {
var key_2025 = temp__5724__auto___2024;
(jsprops["key"] = key_2025);
}
...
var temp__5724__auto___2026 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5724__auto___2026 == null)){
} else {
var key_2027 = temp__5724__auto___2026;
reagent.impl.template.oset.call(null,jsprops,"key",key_2027);
}
...
var G__2028 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__2028["name"] = c);
...
var len__4641__auto___2033 = arguments.length;
var i__4642__auto___2034 = (0);
while(true){
if((i__4642__auto___2034 < len__4641__auto___2033)){
args__4647__auto__.push((arguments[i__4642__auto___2034]));

var G__2035 = (i__4642__auto___2034 + (1));
i__4642__auto___2034 = G__2035;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq2031){
var G__2032 = cljs.core.first.call(null,seq2031);
var seq2031__$1 = cljs.core.next.call(null,seq2031);
var self__4628__auto__ = this;
return self__4628__auto__.cljs$core$IFn$_invoke$arity$variadic(G__2032,seq2031__$1);
});
...
break;
default:
var G__2038 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__2038;
continue;
...
var n__4518__auto___2040 = a.length;
var i_2041 = (0);
while(true){
if((i_2041 < n__4518__auto___2040)){
(a[i_2041] = reagent.impl.template.as_element.call(null,(a[i_2041])));

var G__2042 = (i_2041 + (1));
i_2041 = G__2042;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__4518__auto___2043 = a.length;
var i_2044 = (0);
while(true){
if((i_2044 < n__4518__auto___2043)){
var val_2045 = (a[i_2044]);
if(((cljs.core.vector_QMARK_.call(null,val_2045)) && ((reagent.impl.template.key_from_vec.call(null,val_2045) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_2044] = reagent.impl.template.as_element.call(null,val_2045));

var G__2046 = (i_2044 + (1));
i_2044 = G__2046;
continue;
} else {
}
...
var ctx = ({});
var vec__2047 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__2047,(0),null);
var derefed = cljs.core.nth.call(null,vec__2047,(1),null);
...
var G__2050 = (cljs.core.count.call(null,argv) - first_child);
switch (G__2050) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__2050){
